...
public class ArticleTopBean {
    ...
    @SerializedName("data")
    private List<ArticleTopDataBean> data;
    @SerializedName("errorCode")
    private Integer errorCode;
    @SerializedName("errorMsg")
    private String errorMsg;

    public List<ArticleTopDataBean> getData() {
        return data;
    }

    public void setData(List<ArticleTopDataBean> data) {
        this.data = data;
    }
    ...
    public class ArticleTopDataBean {
        ...
        public List<TopTagsBean> getTags() {
            return tags;
        }

        public void setTags(List<TopTagsBean> tags) {
            this.tags = tags;
        }
